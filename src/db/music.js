let musicDB = [
    {
        ...
        timesPlayed: 0,
        type: "electronic",
        musicName: "Gustixa - lemon tree.mp3",
        attribution: {
            song: "Gustixa - lemon tree.mp3",
            musicBy: "NoCopyrightSounds",
            download: "https://downloadlagu321.net/dl/MunnYFmqWYo",
            stream: "https://www.youtube.com/watch?v=MunnYFmqWYo"
        }
    },
    {
        id: 1,
        ...
        timesPlayed: 0,
        type:"remix",
        musicName: "Gustixa - play date (lofi remix) LYRICS.mp3",
        attribution: {
            song: "Gustixa - play date (lofi remix) LYRICS.mp3",
            musicBy: "Gustixa",
            download: null,
            stream: "https://www.youtube.com/watch?v=dVzNXEOfHNs"
        }
    },
    {
        id: 2,
        ...
        author_name: " Gustixa",
        img: "fallinginlove.jpg",
        lang: "ENGLISH",
        type: "remix",
        timesPlayed: 0,
        musicName: "Gustixa - falling in love (ft. Yara Fabricante).mp3",
        attribution: {
            song: "Gustixa - falling in love (ft. Yara Fabricante).mp3",
            musicBy: "Gustixa",
            download: "https://downloadlagu321.net/dl/MunnYFmqWYo",
            stream: null
        }
    ...
    },
    {
        ...
        timesPlayed: 0,
        type: "remix",
        musicName: "(DownloadLagu321.Net) Gustixa Death Bed ft Shalom Margaret.mp3",
        attribution: {
            song: "(DownloadLagu321.Net) Gustixa Death Bed ft Shalom Margaret.mp3",
            musicBy: "Gustixa",
    ...
    {
        id: 5,
        name: "Happy-Gustixa ft Nida Havia",
        author_name: "Gustixa",
        img: "Happy.jpg",
        lang: "ENGLISH",
        timesPlayed: 0,
        type: "electronic",
        musicName: "happy (Gustixa ft. Nida Havia).mp3",
        attribution: {
            song: "happy (Gustixa ft. Nida Havia).mp3",
            musicBy: "Skinnyfabs",
            download: null,
            stream: null
        }
    },
    {
        id: 6,
        name: "Past Live",
        author_name: "Gustixa-Remix",
        img: "Pastlive.jpg",
        lang: "ENGLISH",
        timesPlayed: 0,
        type:"remix",
        musicName: "Gustixa - past lives remix.mp3",
        attribution: {
            song: "Gustixa - past lives remix.mp3",
            musicBy: "Gustixa",
            download: null,
            stream: null
        }
    },
    {
        id: 7,
        name: "Bitter Love",
        author_name: "ardhito pramono",
        img: "Bitterlove.png",
        lang: "ENGLISH",
        timesPlayed: 0,
        type:"jazz",
        musicName: "Ardhito Pramono - bitterlove (Official Video).mp3",
        attribution: {
            song: "Ardhito Pramono - bitterlove (Official Video).mp3",
            musicBy: "ardhito pramono",
            download: null,
            stream: null
        }
    },
    {
        id: 8,
        name: "One Only",
        author_name: "Pamungkas",
        img: "Oneonly.jpg",
        lang: "ENGLISH",
        timesPlayed: 0,
        type: "jazz",
        musicName: "Pamungkas - One Only (Lyrics Video).mp3",
        attribution: {
            song: "Pamungkas - One Only (Lyrics Video).mp3",
            musicBy: "Pamungkas",
            download: null,
            stream: null
        }
    },
    {
      ...
      name: "Kenangan Manis",
      author_name: "Pamungkas",
      img: "Pamungkas - Kenangan Manis.jpg",
      lang: "Indonesia",
      timesPlayed: 0,
      type: "jazz",
      musicName: "Pamungkas - Kenangan Manis (Lyrics Video).mp3",
      attribution: {
          song: "Pamungkas - Kenangan Manis (Lyrics Video).mp3",
          musicBy: "Pamungkas",
          download: null,
          stream: null
      }
  ...
  {
    id: 10,
    name: "DJ Tiktok Remix Full BASS FULL",
    author_name: "Dj Opus Team",
    img: "djopus.jpg",
    lang: "Indonesia",
    timesPlayed: 0,
    type: "djtiktok",
    musicName: "Dj Tik Tok terbaru 2020 - Dj Saranghae Tik Tok Remix Terbaru 2020 Full Bass Viral Enak.mp3",
    attribution: {
        song: "Dj Tik Tok terbaru 2020 - Dj Saranghae Tik Tok Remix Terbaru 2020 Full Bass Viral Enak.mp3",
        musicBy: "Pamungkas",
        download: null,
